...
class DatabaseServicer(database_pb2_grpc.DatabaseServicer):
    ...
    def put(self, request: database_pb2.String2, context) -> database_pb2.Vazia:
        self.db.put(request.fst, request.snd)
        return database_pb2.Vazia()
    ...
    def deletar(self, request: database_pb2.String, context) -> database_pb2.Vazia:
        self.db.delete(request.value)
        return database_pb2.Vazia()
